...
export async function getIssues(repo, maxRequestAmount, token) {
    const patchRes = await getIssuesPage(repo, token)
    ...
    const resArray = await Promise.all(
        requestPages.map((page) => {
            return getIssuesPage(repo, token, page);
        })
    );
...
export async function getCommits(repo, maxRequestAmount, token) {
